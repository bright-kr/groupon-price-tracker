...
Info  : https://brightdata.co.kr/products/insights/price-tracker/groupon
"""
...
# https://brightdata.co.kr/products/web-scraper/groupon
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Groupon scraper at: https://brightdata.co.kr/products/web-scraper/groupon\n"
